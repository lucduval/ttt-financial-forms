            ...
            {results.isLoss ? (
              ...
              <div className="bg-gradient-to-br from-[#0077BB] to-[#01527e] rounded-2xl shadow-xl text-white p-8">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 border-t border-white/10 pt-6">
                  <div>
                    <p className="text-blue-200 text-sm mb-1">You Keep</p>
                    <p className="text-xl font-semibold">
                      R {fmt(results.netInPocket)}
                    </p>
                  </div>
                  <div>
                    <p className="text-blue-200 text-sm mb-1">Effective Rate</p>
                    <p className="text-xl font-semibold">
                      {results.effectiveRate.toFixed(1)}%
                    </p>
                  </div>
                  <div>
                    <p className="text-blue-200 text-sm mb-1">Marginal Rate</p>
                    <p className="text-xl font-semibold">
                      {(results.marginal * 100).toFixed(0)}%
                    </p>
                  </div>
