            ...
            {isBenefit ? (
              <div className="bg-gradient-to-br from-emerald-600 to-emerald-800 rounded-2xl shadow-xl text-white p-5 sm:p-8">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4 border-t border-white/20 pt-6">
                  ...
                  <div>
                    <p className="text-emerald-100 text-xs sm:text-sm mb-1">Per 30 Days</p>
                    <p className="text-lg sm:text-xl font-semibold">
                      R {fmt(results.dailyBenefit * 30)}
                    </p>
                  </div>
                  <div>
                    <p className="text-emerald-100 text-xs sm:text-sm mb-1">Credit Days</p>
                    <p className="text-lg sm:text-xl font-semibold">{results.creditDays}</p>
                  </div>
                </div>
              </div>
            ) : (
              <div className="bg-gradient-to-br from-[#0077BB] to-[#01527e] rounded-2xl shadow-xl text-white p-5 sm:p-8">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4 border-t border-white/20 pt-6">
                  <div>
                    <p className="text-blue-100 text-xs sm:text-sm mb-1">Employer Pays</p>
                    <p className="text-lg sm:text-xl font-semibold">
                      R {fmt2(results.employerMonthly)}
                    </p>
                  </div>
                  <div>
                    <p className="text-blue-100 text-xs sm:text-sm mb-1">Total to the Fund</p>
                    <p className="text-lg sm:text-xl font-semibold">
